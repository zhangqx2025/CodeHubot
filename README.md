...
**CodeHubot** 是一个跨学科项目制的 AI-IoT 智能教学平台。平台通过将大语言模型与真实的 ESP32 物联网硬件结合，让学生能够动手搭建智能硬件系统、训练能听懂人话的 AI 助手。平台提供完整的智能体构建工具、物联网设备管理系统、开源硬件生态（以及丰富的跨学科教学实验，支持项目式学习，让学生在创造真实作品的过程中理解 AI 和物联网技术，真正做到"让 AI 教学不再纸上谈兵"。

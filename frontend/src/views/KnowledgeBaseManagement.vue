    ...
    <el-card>
      ...
      <div v-loading="loading" class="kb-grid">
        ...
        >
          ...
          <div class="kb-stats">
            <el-statistic title="文档" :value="kb.document_count" />
            <el-statistic title="文本块" :value="kb.chunk_count" />
            <el-statistic title="大小" :value="formatSize(kb.total_size)" />
          </div>
...
const confirmDelete = (kb) => {
  ElMessageBox.confirm(`确定要删除知识库"${kb.name}"吗？`, '确认删除', {

...
export function getMyClubClasses() {
  return request({
    url: '/pbl/student/club/my-classes',
    method: 'get'
  })
}
...
export function getMyClubCourses() {
  return request({
    url: '/pbl/student/club/my-courses',
    method: 'get'
  })
}
...
export function getAvailableClubClasses(params) {
  return request({
    url: '/pbl/student/club/available-classes',
    method: 'get',
    params
  })
}
...
export function joinClubClass(data) {
  return request({
    url: '/pbl/student/club/join-class',
    method: 'post',
    data
  })
}
...
export function getStudentClubClassDetail(classUuid) {
  return request({
    url: `/pbl/student/club/class/${classUuid}`,
    method: 'get'
  })
}

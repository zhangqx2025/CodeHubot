...
import { getClubClassDetail, getGroups } from '@pbl/admin/api/club'
...
const editClass = () => {
  router.push(`/pbl/admin/classes/${route.params.uuid}/edit`)
}

const viewMembers = () => {
  router.push(`/pbl/admin/classes/${route.params.uuid}/members`)
}
...
const viewGroups = () => {
  router.push(`/pbl/admin/classes/${route.params.uuid}/groups`)
}

const viewTeachers = () => {
  router.push(`/pbl/admin/classes/${route.params.uuid}/teachers`)
}

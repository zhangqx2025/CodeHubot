...
export function getKnowledgeBaseTree(params) {
  return request({
    url: '/ai/knowledge-bases/hierarchy-tree',
    method: 'get',
    params
  })
}
...
export function getGlobalStatistics() {
  return request({
    url: '/ai/knowledge-bases/statistics/global',
    method: 'get'
  })
}
...
export function previewDocumentChunks(kb_uuid, formData) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/preview`,
    method: 'post',
    data: formData,
...
export function getDocument(kb_uuid, doc_uuid, include_content = true) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/${doc_uuid}`,
    method: 'get',
    params: {
      include_content
    }
...
export function triggerEmbedding(kb_uuid, doc_uuid, force = false) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/${doc_uuid}/embed`,
    method: 'post',
    data: { force }
  })
}
...
export function getDocumentChunks(kb_uuid, doc_uuid, params) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/${doc_uuid}/chunks`,
    method: 'get',
    params
  })
}
...
export function downloadDocument(kb_uuid, doc_uuid) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/${doc_uuid}/download`,
    method: 'get',
    responseType: 'blob'
  })
}
...
export function getSearchSuggestions(params) {
  return request({
    url: '/ai/knowledge-bases/suggestions',
    method: 'get',
    params
  })
}
...
export function getAvailableKnowledgeBases(agent_uuid) {
  return request({
    url: `/ai/knowledge-bases/agents/${agent_uuid}/available-knowledge-bases`,
    method: 'get'
  })
}
...
export function getAgentKnowledgeBases(agent_uuid) {
  return request({
    url: `/ai/knowledge-bases/agents/${agent_uuid}/knowledge-bases`,
    method: 'get'
  })
}
...
export function batchAddAgentKnowledgeBases(agent_uuid, knowledge_bases) {
  return request({
    url: `/ai/knowledge-bases/agents/${agent_uuid}/knowledge-bases/batch`,
    method: 'post',
...
export function updateAgentKnowledgeBase(agent_uuid, kb_uuid, data) {
  return request({
    url: `/ai/knowledge-bases/agents/${agent_uuid}/knowledge-bases/${kb_uuid}`,
    method: 'put',
    data
  })
}
...
export function searchInKnowledgeBase(kb_uuid, params) {
  return request({
    url: `/ai/kb-documents/${kb_uuid}/search`,
    method: 'post',
    params,

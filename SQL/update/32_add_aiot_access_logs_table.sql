-- ============================================================================
-- 32_add_device_access_logs_table.sql
-- 创建设备访问日志表（config-service 使用）
-- 
-- 功能说明：
-- - 记录设备配置服务的访问日志
-- - 用于简单的速率限制和安全审计
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='设备访问日志表（用于速率限制和安全审计）';

-- 脚本执行完成提示
SELECT 'device_access_logs 表创建成功' AS result;

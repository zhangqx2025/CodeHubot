...
CREATE TABLE `aiot_core_users` (
  ...
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '用户邮箱（可选）',
...
CREATE TABLE `aiot_core_products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `product_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品代码',
...
CREATE TABLE `aiot_core_devices` (
  ...
  `device_secret` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备密钥',
  `firmware_version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '固件版本',
  `hardware_version` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '硬件版本',
...
CREATE TABLE `aiot_core_firmware_versions` (
  ...
  `release_notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '发布说明',
  `is_active` tinyint(1) NOT NULL DEFAULT '1' COMMENT '是否激活',

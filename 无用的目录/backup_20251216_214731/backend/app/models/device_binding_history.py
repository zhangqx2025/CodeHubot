...
class DeviceBindingHistory(Base):
    ...
    # 用户信息
    user_id = Column(Integer, ForeignKey("core_users.id"), nullable=False, index=True, comment="绑定用户ID")
    ...
    # 产品信息
    product_id = Column(Integer, ForeignKey("device_products.id"), nullable=True, comment="产品ID")
